...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TREATEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TREATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TREATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TREATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TREATEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TREATEMENT actions', async () => {
      const expectedActions = [
        {
