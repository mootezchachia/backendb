...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './items.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMS_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMS actions', async () => {
      const expectedActions = [
        {
